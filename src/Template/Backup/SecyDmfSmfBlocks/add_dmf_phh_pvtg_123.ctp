                        ...
                        <div class="container-fluid">
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="form"><b>परिवहन की गई खाद्यान्न की मात्रा (क्विंटल में)(1) :</b></label>
                                            <div class="Month_pick">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="form"><b>भुगतेय राशि (रूपये में)(2) :</b></label>
                                            <div class="Month_pick">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="form"><b>भुगतान की गयी राशि (रूपये में)(3) :</b></label>
                                            <div class="Month_pick">
                                                <?php echo $this->Form->control('toPay1', ['label' => '', 'class' => 'form-control toPay1 numonly', 'placeholder' => '0.00']); ?>
                    ...
                    <div class="container-fluid">
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="form"><b>परिवहन की गई खाद्यान्न की मात्रा (क्विंटल में)(4) :</b></label>
                                            <?php echo $this->Form->control('dsdQuantity2',  [ 'label'=>'','class' => 'form-control numonly', 'placeholder' => '0.00']); ?>
                                        </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="form"><b>भुगतेय राशि (रूपये में)(5) :</b></label>
                                            <div class="Month_pick">
                                                <?php echo $this->Form->control('forPay2',  ['label'=>'', 'class' => 'form-control numonly','placeholder'=>'0.00']); ?>
                                            </div>
                                        </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="form"><b>भुगतान की गयी राशि (रूपये में)(6) :</b></label>
                                            <div class="Month_pick">
                                                <?php echo $this->Form->control('toPay2',  ['label'=>'', 'class' => 'form-control toPay2 numonly','placeholder'=>'0.00']); ?>
                                            </div>
                                        </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="Month_pick">
                                            <?php echo $this->Form->control('totalPayable', ['readonly' => 'readonly', 'label' => '', 'class' => 'form-control totalPaid', 'placeholder' => '0.00']); ?>
                                        </div>
                                    </div>
                                </div>
                       ...
                       <div class="container-fluid">
                                       ...
                                       <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                           <div class="form-group">
                                               <label for="form"><b>परिवहन की गई खाद्यान्न की मात्रा (क्विंटल में)
                                                       :</b></label>
                                               <div class="Month_pick">
                                                   <?php echo $this->Form->control('quantity1', ['label' => '', 'class' => 'form-control numonly', 'placeholder' => '0.00']); ?>
                           ...
                           <fieldset>
                               <div class="row rounded-bottom border-bottom border border-primary" style="margin-bottom: 21px;">
                                   ...
                                   <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 frmDec">
                                       <div class="form-group">
                                           <label for="form"><b>प्रतिवेदित माह हेतु आवंटित खाद्यान्न (क्विंटल में)(2) :</b></label>
                                           <div class="Month_pick">
                                   ...
                                   <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                           <label for="form"><b>पैकेजिंग हेतु उपलब्ध कराये गये खाद्यान्न की मात्रा (क्विंटल में)(3) :</b></label>
                                           <div class="Month_pick">
                                   ...
                                   <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                           <label for="form"><b>उपलब्ध कुल खाद्यान की मात्रा (क्विंटल में )(4)=(1+3) :</b></label>
                                           <div class="Month_pick">
...
<script>
    jQuery(document).ready(function(){
        ...
        $(".currMnth, .BenCount").blur(function(){
        ...
        $(".toPay2").blur(function () {
            var toPay1      = parseFloat($(".toPay1").val());
            var toPay2      = parseFloat($(".toPay2").val());
            var total_val   = parseFloat($(".totalPayable").val());
            var totalPaid   = toPay1 + toPay2 ;
            alert('totalPaid'); return false;
            if(!isNaN(totalPaid)) {
                $(".totalPayable").val(totalPaid);
            }
        });
    });
</script>
