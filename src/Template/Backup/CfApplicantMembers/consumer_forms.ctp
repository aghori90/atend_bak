                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <?php echo $this->Form->control('post', ['label' => '', 'class' => 'form-control inpt', 'value' => $vacName, 'disabled' => 'disabled']); ?>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                            <div class="form-group">
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <script language="javascript">
                            CreateCustomHindiTextBox("namHn", "", "form-control txtOnly inpt", true);
                        </script>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <script language="javascript">
                            CreateCustomHindiTextBox("fatNamHn", "", "form-control txtOnly inpt", true);
                        </script>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <?php echo $this->Form->control('permantAdd', ['label' => '', 'class' => 'form-control ads inpt', 'placeholder'=>'Enter Permanent Address ']); ?>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>अस्थायी पत्राचार का पता :</b></label>
                            <?php echo $this->Form->control('currAdd', ['label' => '', 'class' => 'form-control ads inpt', 'placeholder'=>'Enter Current Address ']); ?>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
...
<!--                    </div>-->
        ...
        <?php echo $this->Form->create('member2', ['url' => ['controller' => 'CfApplicantMembers', 'action' => 'consumerForms']]); ?>
        <!--        <div class="valid">--><?php //echo $this->Flash->render(); ?><!--</div>-->
        <div class="container-fluid">
...
<!--                        --><?php //$wrkPlace = ['1' => 'न्यायिक ', '2' => 'गैर न्यायिक'] ?>
                    ...
                    <div class="form-group">
                        <table class="table table-bordered" border="1">
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->Form->control('graduPrecntMrk', ['label' => '', 'class' => 'form-control numonly bxDco','placeholder'=>'Enter Percentage','readonly'=>'readonly']); ?></td>
                            </tr>
                            <tr>
                                ...
                                <td><?php echo $this->Form->control('masterPrecntMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Percentage','readonly'=>'readonly']); ?></td>
                            </tr>
                            <tr>
                                <td><b>Ph.D.</b></td>
                                <td>
                                ...
                                <td><?php echo $this->Form->control('phdPrecntMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Percentage','readonly'=>'readonly']); ?></td>
                            </tr>
                            </thead>
                        </table>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                    <div class="form-group mnth">
                        <?php echo $this->Form->control('exp2Month', ['label' => '', 'class' => 'form-control numonly','placeholder'=>'In Months','minLength'=>'1','maxLength'=>'3']); ?>
                    </div>
                ...
                <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                    <div class="form-group mnth">
                        <?php echo $this->Form->control('exp3Mnth', ['label' => '', 'class' => 'form-control numonly','placeholder'=>'In Months','minLength'=>'1','maxLength'=>'3']); ?>
                    </div>
                </div>
                <!--3-->
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                    <div class="form-group mnt">
                        <?php echo $this->Form->control('exp4Mnth', ['label' => '', 'class' => 'form-control numonly','placeholder'=>'Exp In Months','minLength'=>'1','maxLength'=>'3']); ?>
                    </div>
                </div>
                <!--4-->
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                    <div class="form-group mnth">
                        <?php echo $this->Form->control('exp5Mnth', ['label' => '', 'class' => 'form-control numonly','placeholder'=>'Exp In Months','minLength'=>'1','maxLength'=>'3']); ?>
                    </div>
                </div>
                <!--5-->
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                    <div class="form-group mnth">
                        <?php echo $this->Form->control('exp6Mnth', ['label' => '', 'class' => 'form-control numonly','placeholder'=>'Exp In Months','minLength'=>'1','maxLength'=>'3']); ?>
                    </div>
                </div>
                <!--6-->
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                    <div class="form-group mnth">
                        <?php echo $this->Form->control('exp7Mnth', ['label' => '', 'class' => 'form-control numonly','placeholder'=>'Exp In Months','minLength'=>'1','maxLength'=>'3']); ?>
                    </div>
                </div>
                <!--knownAddress-->
                <!--                <div class="kwnAdd">-->
        ...
        <!--<span id="totExpinmonthErrMsgVacTwo" class="frm_error"></span>-->
        <div class="row" style="display:none;">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <span id="totExpinmonthErrMsgVacTwo" class="frm_error" style="font-style:italic;">Minimum 15 yrs experience required in months !.</span>
                </div>
            </div>
        ...
        <div>
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="btnDeco">
                    <button type="submit" class="btn btn-outline-success" id="btnSaveVacancy">Save & Next</button>
                </div>
            </div>
        </div>
        <?php
...
<?php } ?>
        ...
        <!--    <div class="card-header bg-primary text-white">Form III</div>-->
            <div class="container-fluid">
                <div class="row">
                                <?php echo $this->Form->create('vaccThree',['url'=>['controller'=>'CfApplicantMembers', 'action'=>'consumerForms']]); ?>
                    <div class="valid">
                        <?php echo $this->Flash->render(); ?>
                    </div>
                    <div class="container-fluid">
...
<!--                                    --><?php //$wrkPlace = ['1'=>'अध्यक्ष,जिला आयोग'] ?>
                                    <?php echo $this->Form->control('post',['label' => '', 'class' => 'form-control','value' => 'अध्यक्ष,जिला आयोग','readonly'=>'readonly']); ?>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            <div class="form-group">
    ...
    <!--                            --><?php //echo $this->Form->select('multiiDist',$districts, ['label' => '','id'=>'multiDist', 'class' => 'form-control','multiple'=>'multiple']); ?>
                                <?php echo $this->Form->control('multiiDist', ['label' => '', 'class' => 'form-control']); ?>
                            </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                <div class="form-group">
...
<!--                        </div>-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="form"><b>क्या जिला न्यायालय के न्यायाधीश है, या रह चुके है या होने के लिए अर्हित है? :</b></label>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                <div class="form-group radee">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                <div class="form-group radee">
                                    <?php echo $this->Form->control('expInMnth', ['label' => '', 'class' => 'form-control numonly inpt', 'placeholder'=>'Enter Exp In Months','minLength'=>'1','maxLength'=>'3']); ?>
                                </div>
...
<!--                                    --><?php //$wrkPlace = ['1'=>'अध्यक्ष,जिला आयोग'] ?>
    ...
    <!--                            --><?php //echo $this->Form->select('multiiDist',$districts, ['label' => '','id'=>'multiDist', 'class' => 'form-control','multiple'=>'multiple']); ?>
                        ...
                        <div class="form-group">
                            <table class="table table-bordered" border="1">
                                ...
                                <tr>
                                    <td><b>स्नातक</b></td>
                                    <td><b>अनिवार्य</b></td>
                                    <td><?php echo $this->Form->control('graduTotMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Total Marks','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                    <td><?php echo $this->Form->control('graduObtMrk', ['label' => '', 'class' => 'form-control numonly bxDco','placeholder'=>'Enter Obtain Marks','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                    <td><?php echo $this->Form->control('graduPrecntMrk', ['label' => '', 'class' => 'form-control numonly bxDco','placeholder'=>'Enter Percentage','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                </tr>
                                <tr>
                                    <td><b>स्नात्तोकोत्तर</b></td>
                                    <td>
                                        <?php $app = ['1' => 'हाँ', '2' => 'नहीं'] ?>
                                        <?php echo $this->Form->radio('master', $app, ['label' => '', 'class' => 'rad']); ?>
                                    </td>
                                    <td><?php echo $this->Form->control('masterTotMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Total Marks','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                    <td><?php echo $this->Form->control('masterObtMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Obtain Marks','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                    <td><?php echo $this->Form->control('masterPrecntMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Percentage','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                </tr>
                                <tr>
                                    <td><b>Ph.D.</b></td>
                                    <td>
                                    ...
                                    <td><?php echo $this->Form->control('phdTotMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Total Marks','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                    <td><?php echo $this->Form->control('phdObtMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Obtain Marks','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                    <td><?php echo $this->Form->control('phdPrecntMrk', ['label' => '', 'class' => 'form-control numonly bxDco', 'placeholder'=>'Enter Percentage','maxlength'=>'4' ,'minlength'=>'2']); ?></td>
                                </tr>
                                </thead>
                            </table>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>केन्द्र सरकार के राजपत्रित पदाधिकारी के रूप में :</b></label>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="form-group radee">
                    ...
                    <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12 mnthExp">
                        <div class="form-group mnth">
                            <?php echo $this->Form->control('exp2Month', ['label' => '', 'class' => 'form-control   numonly expMnt', 'placeholder'=>'Exp In Months','maxlength'=>'3' ,'minlength'=>'1']); ?>
                        </div>
                    </div>
                    <!--2-->
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>राज्य सरकार के राजपत्रित पदाधिकारी के रूप में :</b></label>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="form-group radee">
                    ...
                    <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12 mnthExp">
                        <div class="form-group mnth">
                            <?php echo $this->Form->control('exp3Mnth', ['label' => '', 'class' => 'form-control  numonly expMnt', 'placeholder'=>'Exp In Months','maxlength'=>'3' ,'minlength'=>'1']); ?>
                        </div>
                    </div>
                    <!--3-->
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>केन्द्र सरकार के सार्वजनिक क्षेत्र इकाई के कर्मी के रूप में  :</b></label>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="form-group radee">
                    ...
                    <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                        <div class="form-group mnt">
                            <?php echo $this->Form->control('exp4Mnth', ['label' => '', 'class' => 'form-control numonly expMnt', 'placeholder'=>'Exp In Months','maxlength'=>'3' ,'minlength'=>'1']); ?>
                        </div>
                    </div>
                    <!--4-->
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>राज्य सरकार के सार्वजनिक क्षेत्र इकाई के कर्मी या झारखण्ड उपभोक्ता विवाद निवारण आयोग/जिला उपभोक्ता विवाद निवारण फोरम में अध्यक्ष/सदस्य के रूप में :</b></label>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="form-group radee">
                    ...
                    <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                        <div class="form-group mnth">
                            <?php echo $this->Form->control('exp5Mnth', ['label' => '', 'class' => 'form-control numonly expMnt', 'placeholder'=>'Exp In Months','maxlength'=>'3' ,'minlength'=>'1']); ?>
                        </div>
                    </div>
                    <!--5-->
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                        <div class="form-group mnth">
                            <?php echo $this->Form->control('exp6Mnth', ['label' => '', 'class' => 'form-control numonly expMnt', 'placeholder'=>'Exp In Months','maxlength'=>'3' ,'minlength'=>'1']); ?>
                        </div>
                    </div>
                    <!--6-->
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>क्या खाद्य, सार्वजनिक वितरण एवं उपभोक्ता मामले विभाग, झारखण्ड अथवा झारखण्ड उपभोक्ता विवाद निवारण आयोग अथवा झारखण्ड के जिला उपभोक्ता विवाद निवारण फोरम में (राज्य आयोग/जिला फोरम के संबंध में अध्यक्ष/सदस्य से अलग) किसी पद पर भी कार्य किया है? :</b></label>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        <div class="form-group radee">
                    ...
                    <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                        <div class="form-group mnth">
                            <?php echo $this->Form->control('exp7Mnth', ['label' => '', 'class' => 'form-control numonly expMnt', 'placeholder'=>'Exp In Months','maxlength'=>'3' ,'minlength'=>'1']); ?>
                        </div>
                    </div>
                    <!--knownAddress-->
                    <!--                <div class="kwnAdd">-->
                ...
                <!--Self Declaration -->
                <div class="card-header bg-primary text-white">स्व-घोषणा :</div>
                <div class="row">
                    <!--1-->
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>क्या राज्य सरकार की राय में सदस्य के रूप में उसके कार्यों से वित्तीय अथवा अन्य लाभों पर हानिकारक प्रभाव पड़ने की संभावना है?   :</b></label>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group radee">
            ...
            <!--<span id="totExpinmonthErrMsgVacFour" class="frm_error" style="display:none;"></span>-->
<!--            <div class="row" style="display:none;">-->
<!--                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">-->
<!--                    <span id="totExpinmonthErrMsgVacFour" class="frm_error" style="font-style:italic;">Minimum 15 yrs experience required in months !.</span>-->
<!--                </div>-->
<!--            </div>-->
            <!--Submit-->
            <div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // }
		/*if(vacancy_id == 2){
			$("input[name=ghosna6]").click(function () {
				var exp2_m = $('#exp2month').val();
				var exp3_m = $('#exp3mnth').val();
				var exp4_m = $('#exp4mnth').val();
				var exp5_m = $('#exp5mnth').val();
				var exp6_m = $('#exp6mnth').val();
				var exp7_m = $('#exp7mnth').val();
				var totExp = '';
                $totExp = parseInt(exp2_m) + parseInt(exp3_m) + parseInt(exp4_m) + parseInt(exp5_m) + parseInt(exp6_m) + parseInt(exp7_m);
                if($totExp < 180){
                    $('#totExpinmonthErrMsgVacTwo').show();
                    $('#totExpinmonthErrMsgVacTwo').html('Minimum 15 yrs experience required in months !.');
                    $('#btnSaveVacancyTwo').attr('disabled', true);
                }
				/*if((exp2_m != '') || (exp3_m != '') || (exp4_m != '') || (exp5_m != '') || (exp6_m != '') || (exp7_m != '')){
        ...
        // }
		/*if(vacancy_id == 4){
			$("input[name=ghosna6]").click(function () { //alert("fgf");return false;
				var exp2_m = $('#exp2month').val();
				var exp3_m = $('#exp3mnth').val();
				var exp4_m = $('#exp4mnth').val();
				var exp5_m = $('#exp5mnth').val();
                ...
                $totExp = parseInt(exp2_m) + parseInt(exp3_m) + parseInt(exp4_m) + parseInt(exp5_m) + parseInt(exp6_m) + parseInt(exp7_m);
                if($totExp < 180){
                    $('#totExpinmonthErrMsgVacFour').show();
                    $('#totExpinmonthErrMsgVacFour').html('Minimum 15 yrs experience required in months !.');
        ...
        $('#graduobtmrk').blur(function() {
          ...
          // alert(gradutotmrk);
          if(gradutotmrk){
              jQuery("#graduprecntmrk").val(((jQuery(this).val()*100)/gradutotmrk).toFixed(2));
          }
        });
        // master
        $('#masterobtmrk').blur(function() {
          ...
          // alert(gradutotmrk);
          if(mastertotmrk){
              jQuery("#masterprecntmrk").val(((jQuery(this).val()*100)/mastertotmrk).toFixed(2));
          }
        });
        // Phd
        $('#phdobtmrk').blur(function() {
          ...
          // alert(gradutotmrk);
          if(phdtotmrk){
              jQuery("#phdprecntmrk").val(((jQuery(this).val()*100)/phdtotmrk).toFixed(2));
          }
        });
