...
<div class="mt-4" id="b-inner-sec">
    <div class="container">
        <div class="card">
            ...
            <!--            --><?php //echo $this->Form->create('frmSrch',['url'=>['controller'=>'CfApplicantMembers', 'action'=>'consumerDocuments']]); ?>
            <div class="valid">
            ...
            <div class="container-fluid">
                ...
                <?php if ($sessionVacId == 1){ ?>
                                <?php echo $this->Form->create('frmSrch',['type'=>'file','url'=>['controller'=>'CfApplicantMembers', 'action'=>'consumerDocuments']]); ?>
                    <div class="valid">
                        <?php echo $this->Flash->render(); ?>
                    </div>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="form"><b>अपने द्वारा पारित सिविल केस के संबंध में दो न्यायादेशों की छायाप्रति :</b></label>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="form"><b>अपने द्वारा पारित क्रिमिनल केस के संबंध में दो न्यायादेशों की छायाप्रति  :</b></label>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="form"><b>यदि अन्य विशेष अनुभव के संबंध में हाँ है तो विवरणी संलग्न करें :</b></label>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="form">
                                        ...
                                        मैं यह घोषित करता हूँ/करती हूँ कि मेरे द्वारा दी गई सभी सूचना मेरे संज्ञान से सत्य एवं पूर्ण सही है। अगर दी गई सूचना गलत अथवा असत्य पाया जाता है तो कभी भी मेरी उम्मीदवारी/नियुक्ति को रद्द कर दी जा सकती है एवं मेरे ऊपर कानूनी कार्रवाई की जा सकती है।
                                    </label>
                                </div>
                            </div>
...
<!--                    <div>-->
        ...
        <?php } ?>
                <?php if ($sessionVacId == 2){ ?>
                    <?php echo $this->Form->create('member2',['type'=>'file','url'=>['controller'=>'CfApplicantMembers', 'action'=>'consumerDocuments']]); ?>
<!--        <div class="valid">--><?php //echo $this->Flash->render(); ?><!--</div>-->
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <!--3-->
                <?php if(!empty($data['master_degree'] == 1)){ ?>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="form-group">
