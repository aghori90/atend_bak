        ...
        <div class="row justify-content-center">
            <div style="width:100%;">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3" style="border:none;">
                    ...
                    <fieldset>
                        <!--Month Picker-->
                        <?php echo $this->Form->create('transactionFrm', ['name' => 'transactionFrm', 'id' => 'transactionFrm', 'url' => ['controller' => 'Reports', 'action' => 'distTransactionDistributionReports']]) ?>
                        ...
                        <small style="color: red; font-weight: 700; margin-left: 15px;">Month/Year: </small><small style="font-weight: bold">
                            <?php
                                ...
                                $yr = $mt[0];
                                $my = $mt[1];
                                echo date("F", mktime(0, 0, 0, $yr, 10)) . " dist_transaction_distribution_reports.ctp" .$my;
                            ?>
                        </small>
...
<!--                        <span data-toggle="tooltip" data-placement="top" title="Download as Excel" onClick = "table_excel('exclDnld', 'Transaction Distribution Report');"><img src="../webroot/img/excle.png" class="suk_st">-->
                        </span>
                        <div>
                            <div class="tabb">
                                <?php echo $this->Form->create('districtDetail',['name'=>'districtDetail','id'=>'districtDetail','url'=>['controller'=>'Reports','action'=>'blkTransactionDistributionReports']]) ?>
                            <table class="table table-bordered border-primary" id="exclDnld">
                                ...
                                <tr>
                                    ...
                                    <th style="position: sticky; width: 130px; left: 0; z-index: 1;" rowspan="4">District</th>
