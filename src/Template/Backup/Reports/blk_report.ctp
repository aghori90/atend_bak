        ...
        <div class="row justify-content-center">
            <div style="width:100%;">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3" style="border:none;">
                    <fieldset>
                        <div class="card-header bg-primary text-white" align="center"><b>BLOCK WISE UID ERROR REPORT</b>
                            <fieldset>
                                <div class="btDec">
                                    <?php echo $this->Form->create('districtFrm',['name'=>'gotToDist','id'=>'gotToDist','url'=>['controller'=>'Reports','action'=>'distReport']]) ?>
                                ...
                                <div class="smDeco">
                                    <small><span style="color: white; font-weight: bold; margin-left: 30%;">Note:</span> Block Name is a link click for more Details.</small>
                        ...
                        <?php echo $this->Form->create('blkDetails',['name'=>'blkDetails','id'=>'blkDetails','url'=>['controller'=>'Reports','action'=>'dealerWiseCount']]) ?>
                        <table class="table table-striped table-bordered">
                            ...
                            $totRepo300 = 0;
                            $totRepoMem300 = 0;
                            foreach($blocks as $dKey => $dVal){ ?>
                                <tr>
                                    <td><?php echo $SlNo;?></td>
                                    <td>
                                        <span class="distButton" onclick="javascript:submitFrm('<?php echo $dKey;?>')"><?php echo $dVal;?></span>
                                    </td>
<!--                                    <td>--><?php //if(isset($distRepo[$dKey])){ echo $distRepo[$dKey]; }else{ echo 0; } ?><!--</td>-->
