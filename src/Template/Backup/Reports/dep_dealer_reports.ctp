            ...
            <div style="width:100%;">
                <div class="frmContent">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                           ...
                           <?php echo $this->Form->control('rgi_district_code',['label'=>'','name'=>'rgi_district_code','id'=>'rgi_district_code','class'=>'form-control','empty'=>'-- Select District --','options'=>$districts,'required'=>'required','value'=>$rgi_district_code]); ?>
                ...
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3" style="border:none;">
                    ...
                    <table cellpadding="0" cellspacing="0" class="table table-striped">
                        ...
                        <tbody>
                        <?php
                        if(!empty($dealerDatas)) {
                            $SlNo = 1;
                            foreach ($dealerDatas as $key => $value) {
