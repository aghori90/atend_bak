                    ...
                    <fieldset>
                        <?php if($this->getRequest()->is('post')) { ?>
                            ...
                            <small style="color: red; font-weight: 700; margin-left: 15px;">Month/Year: </small><small style="font-weight: bold">
                                ...
                                $yr = $mt[0];
                                $my = $mt[1];
                                echo date("F", mktime(0, 0, 0, $yr, 10)) . " blk_transaction_distribution_reports.ctp" .$my;
                                ?>
                            </small>
                            ...
                            <div>
                                <div class="tabb">
                                    <?php echo $this->Form->create('blkDetails',['name'=>'blkDetails','id'=>'blkDetails','url'=>['controller'=>'Reports','action'=>'dlrTransactionDistributionReports']]) ?>
                                    <table class="table table-bordered " id="exclDnld">
                                        <thead style="" align="center">
                                        <tr>
                                            <th style="position: sticky; width: 130px; left: 0; z-index: 1;" rowspan="4">#</th>
                                            <th style="position: sticky; width: 130px; left: 0; z-index: 1;" rowspan="4">Block</th>
                                            <th class="stkHdr" rowspan="4">Dealer Count</th>
