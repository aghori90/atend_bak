        ...
        <div class="row justify-content-center">
            <div style="width:100%;">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3" style="border:none;">
                    ...
                    <fieldset>
<!--                        --><?php //echo $this->Form->create('blkDetails',['name'=>'blkDetails','id'=>'blkDetails','url'=>['controller'=>'Reports','action'=>'dealerWiseDetails']]) ?>
                        <table class="table table-bordered">
                            ...
                            foreach ($dealers as $dealer) { ?>
                                <tr>
                                    <td><?php echo $a++ ?></td>
                                    <td>
                                        <span class="distButton" onclick="javascript:submitFrm('<?php echo $dealer;?>')"><?php echo $dealer;?></span>
                                    </td>
