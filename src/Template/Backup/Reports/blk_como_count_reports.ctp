                ...
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3" style="border:none;">
                    <fieldset>
                        <div class="card-header bg-primary text-white" align="center"><b>BLOCK WISE APWAAD TRANSACTION REPORT</b>
                            <fieldset>
                                <div class="btDec">
                                    <?php echo $this->Form->create('districtFrm',['name'=>'gotToDist','id'=>'gotToDist','url'=>['controller'=>'Reports','action'=>'distComoCountReports']]) ?>
                                    ...
                                    echo $this->Form->hidden('comod',['name'=>'comodity','id'=>'comod','value'=>$commod]);
                                    echo $this->Form->end();
                                    ?>
                                </div>
                                <div class="dstDec">
                        ...
                        <?php echo $this->Form->create('blkDetails',['name'=>'blkDetails','id'=>'blkDetails','url'=>['controller'=>'Reports','action'=>'dlrComoCountReports']]) ?>
                        ...
                        <small style="color: red; font-weight: 700; margin-left: 15px;">Month/Year: </small><small style="font-weight: bold">
                            ...
                            $yr = $mt[0];
                            $my = $mt[1];
                            echo date("F", mktime(0, 0, 0, $yr, 10)) . " blk_como_count_reports.ctp" .$my;
                            ?>
                        </small>
