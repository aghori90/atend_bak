...
<!--                    </div>-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>क्या राज्य सरकार की राय में अध्यक्ष के रूप में उसके कार्यों से वित्तीय अथवा अन्य लाभों पर हानिकारक प्रभाव पड़ने की संभावना है?  :</b></label>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group radee">
...
<!--                                    --><?php //$wrkPlace = ['1'=>'अध्यक्ष,जिला आयोग'] ?>
    ...
    <!--                            --><?php //echo $this->Form->select('multiiDist',$districts, ['label' => '','id'=>'multiDist', 'class' => 'form-control','multiple'=>'multiple']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 kwnAdd">
                        <div class="form-group ">
                            <?php echo $this->Form->control('knownAddress', ['label' => '', 'class' => 'form-control ads radee', 'placeholder'=>'Enter Office Address']); ?>
                        </div>
                    </div>
                    <!--                </div>-->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="form"><b>क्या राज्य सरकार की राय में सदस्य के रूप में उसके कार्यों से वित्तीय अथवा अन्य लाभों पर हानिकारक प्रभाव पड़ने की संभावना है?   :</b></label>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="form-group radee">
