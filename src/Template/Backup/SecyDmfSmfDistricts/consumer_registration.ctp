...
<div class="mt-4" id="b-inner-sec">
    <div class="container">
        <div class="card">
            ...
            <?php echo $this->Form->create('seedUid',['url'=>['controller'=>'SecyDmfSmfDistricts', 'action'=>'consumerRegistration']]); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <?php echo $this->Form->control('dob', ['label'=>'','id'=>'date', 'class' => 'form-control date inpt','placeholder'=>'Enter DOB']); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
